                    ...
                    <div class="col-12">
                        <div class="card border-0 shadow-sm rounded-4 p-4 h-100">
                            ...
                            <p class="text-muted mt-2 mb-0">
                                ...
                                <a href="{{ route('post#detail', $post->id) }}" class="text-success fw-semibold ms-1 text-decoration-none">
                ...
                <div class="list-group shadow-sm">
                    @foreach ($posts as $post)
                        <div data-bs-toggle="modal" data-bs-target="#myModal-{{ $post->id }}"
                            ...
                            <img class="img-fluid rounded me-3" src="{{ asset('home/image/msme.png') }}"
                                 alt="Event Image" style="width:80px; height:60px; object-fit:cover;">
                            <h6 class="mb-0 text-dark flex-grow-1">{{ Str::limit($post->title, 40) }}</h6>
                        </div>
...
<section class="post-container container-fluid py-4">
    <div class="row g-4">
        ...
        <!-- LEFT SIDE (Posts) -->
        <div class="col-12 col-lg-8">
            <h3 class="fw-bold text-success mb-3">💰 Posts Updates</h3>
            <div class="row g-4">
                @foreach ($posts as $post)
                    <div class="col-12">
                    ...
                    @foreach ($posts as $post)
                        ...
                        <div class="modal fade" id="myModal-{{ $post->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title fw-bold text-success">{{ $post->title }}</h5>
