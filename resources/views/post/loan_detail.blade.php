...
@section('content')
 ...
 <section class="post-container container-fluid py-4">
    <div class="row g-4">
        ...
        <!-- LEFT SIDE (Loan Detail) -->
        <div class="col-12 col-lg-7">
            <div class="card shadow-sm rounded-4 p-4 border-0 h-100">
                <div class="btn btn-success mb-3">
                    {{ \Carbon\Carbon::parse($loans->created_at)->format('j-F-Y') }}
                </div>
                <h3 class="fw-bold text-dark mb-3">{{ $loans->name }}</h3>
        ...
        <div class="col-12 col-lg-5">
            <div class="row g-4">
                ...
                <!-- Recent Loans -->
                <div class="col-12">
                    <h5 class="text-center fw-bold text-success mb-3">💰 Recent Loans</h5>

                    @foreach ($recent as $post)
                        <div class="card glass-card mb-3 shadow-sm border-0"
                             data-bs-toggle="modal"
                             data-bs-target="#loanModal-{{ $post->id }}"
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="loanModal-{{ $post->id }}" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content rounded-4 shadow-lg">
                                    <div class="modal-header">
                                        <h5 class="modal-title fw-bold">{{ $post->name }}</h5>
