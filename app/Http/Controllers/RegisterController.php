...
class RegisterController extends Controller
{
    ...
    public function create(Request $request){
        ...
        'nrc_code_mm'=>$request->nrc_region_mm,
        'nrc_code_en'=>$request->nrc_region_en,
        'nrc_state_en'=>$request->nrc_township_en,
        'nrc_state_mm'=>$request->nrc_township_mm,
        'nrc_status_en'=>$request->nrc_type_mm,
        'nrc_status_mm'=>$request->nrc_type_eng,
        'nrc_mm'=>$request->nrc_number_mm,
        'nrc_en'=>$request->nrc_number_eng,
        'father_mm' => $request->father_name_mm,
        'father_en' => $request->father_name_eng,
        'race' => $request->ethinic,
        ...
        return redirect()->route('index#content')->with('success', 'Registration successful!');
